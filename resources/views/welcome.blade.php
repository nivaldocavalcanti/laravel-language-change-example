...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><span class="underline text-gray-900 dark:text-white">@lang("Laravel Change Language Example")</span></div>
                            </div>
                        ...
                        <div class="p-6">
                            <label for="lang">@lang("Select Language"):</label>
    ...
    <script>
        $('#lang').change(function(){
          locale = $(this).val();
          $.post('{{ route('linguagem') }}',{_token: '{{ csrf_token() }}',locale: locale}, function(data){
            if(data){
